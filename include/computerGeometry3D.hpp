...
public:
    ...
    decltype(_vt0(0) + _vt1(0) + _vt2(0) - (_vt0(0) * _vt1(0) * _vt2(0))) extendedCrossproduct(const Vec4<_vt0>& v0, const Vec4<_vt1>& v1, const Vec4<_vt2>& v2){
...
std::ostream& operator<<(std::ostream& os, const cf::Vec4<_VType>& rhs){
    return os;
}
