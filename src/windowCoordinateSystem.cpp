...
void WindowCoordinateSystem::drawLine(const Point& p1, const Point& p2, const Color& color, Window2D::LineType type,
                                      int lineWidth) {
...
void WindowCoordinateSystem::drawLinearEquation(float a, float b, float c, const Color& color, Window2D::LineType type,
                                                int lineWidth) {
    if (std::abs(b) < cf::WindowCoordinateSystem::ZERO_COMPARE) {
        if (std::abs(a) < cf::WindowCoordinateSystem::ZERO_COMPARE) {
            if (std::abs(c) < cf::WindowCoordinateSystem::ZERO_COMPARE) {
                ...
                cf::Console::printWarning(__func__,
                                          " called with with a=b=0 and c != 0, this is ALWAYS FALSE for all x/y pairs");
                return;
            }
        }
        // 0*y = 0
...
void WindowCoordinateSystem::drawLinearEquation(const glm::vec3& vec, const Color& color, Window2D::LineType type,
                                                int lineWidth) {
    this->drawLinearEquation(vec[0], vec[1], vec[2], color, type, lineWidth);
}

void WindowCoordinateSystem::drawLinearEquation(float slope, float yIntercept, const Color& color, Window2D::LineType type,
                                                int lineWidth) {
    cf::Point p1, p2;
...
void WindowCoordinateSystem::drawCirclePart(const Point& center, const Point& p0, const Point& p1, const Color& color,
                                            int lineWidth, bool smallerAngle) {
