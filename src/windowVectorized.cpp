...
cf::WindowVectorized::WindowVectorized(int width, const cf::Interval &range_x, const cf::Interval &range_y, const char *windowName, const cf::Color &startColor)
...
cf::WindowVectorized::WindowVectorized(const char *filePath, int width, const cf::Interval &range_x, const cf::Interval &range_y)
    : Window2D(filePath)
{
    this->setInvertYAxis(true);
    this->setInterval(range_x, range_y, width);
